        ...
        <div className="card-body">
          <div className="d-flex justify-content-between align-items-center gap-5">
                ...
                onClick={() => {
                  if (sessionStorage.getItem("user") === null)
                    ...
                    fetch(
                      ...
                      document.getElementById("upvote").style.color = "#03a9f4";
                      setTimeout(() => {
                        document.getElementById("upvote").style.color = "#fff";
                      }, 2000);
                    });
                  }
                }}
            ...
            <div className="">
              ...
              >
                <ion-icon id="downvote" name="arrow-down-outline"></ion-icon>
              </button>
              {downvotes}
            </div>
          </div>
          <h5 className="card-title">{findNameOfUser(commentObj.userId)}</h5>
